...
class QuestionnaireSingleHolder(
    private val itemBinding: ItemQuestionnaireListBinding,
    private val showList: (FieldTypes.SingleSelect) -> Unit,
    private val showError: (String?) -> Unit
) : RecyclerView.ViewHolder(itemBinding.root) {

    fun bind(entity: FieldTypes.SingleSelect) {
    ...
    private fun ItemQuestionnaireListBinding.setupHint(entity: FieldTypes.SingleSelect) {
    ...
    private fun ItemQuestionnaireListBinding.setupText(entity: FieldTypes.SingleSelect) {
    ...
    private fun ItemQuestionnaireListBinding.setupErrorField(entity: FieldTypes.SingleSelect) {
